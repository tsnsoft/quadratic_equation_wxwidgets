...
Quadratic_equation_wxwidgetsFrame::Quadratic_equation_wxwidgetsFrame(wxWindow* parent,wxWindowID id)
{
    ...
    Create(parent, id, _("Ðåøåíèå êâàäðàòíîãî óðàâíåíèÿ"), wxDefaultPosition, wxDefaultSize, wxDEFAULT_DIALOG_STYLE, _T("id"));
    SetClientSize(wxSize(382,237));
    {
    	wxIcon FrameIcon;
    	FrameIcon.CopyFromBitmap(wxBitmap(wxImage(_T("qe.jpg"))));
    	SetIcon(FrameIcon);
    }
    ...
    Button_Calc = new wxButton(this, ID_BUTTON1, _("Ðåøèòü"), wxPoint(56,136), wxSize(280,40), 0, wxDefaultValidator, _T("ID_BUTTON1"));
